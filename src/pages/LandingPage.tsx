...
import { Sparkles, BookOpen, Trophy, Gamepad2 } from "lucide-react";
    ...
    <div className="relative z-10 container mx-auto px-6 text-center">
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            to="/student"
            className="inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-gradient-gold text-primary-foreground font-semibold text-lg shadow-glow-gold hover:scale-105 transition-transform"
          >
          ...
          <Link
            to="/admin"
            className="inline-flex items-center gap-2 px-8 py-4 rounded-xl glass text-foreground font-semibold text-lg hover:scale-105 transition-transform"
          >
