...
import {
  ...
  BarChart3, MessageSquare, Settings, LogOut, TrendingUp, AlertTriangle,
  ...
  return (
    <div className="p-6">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
        <h1 className="text-2xl font-bold mb-1">Good Morning, <span className="text-gradient-gold">Teacher Cruz!</span></h1>
        ...
        <div className="grid lg:grid-cols-2 gap-6 mb-6">
          ...
          <div className="glass rounded-xl p-5">
            <h3 className="font-semibold mb-4 flex items-center gap-2">
              <BarChart3 className="w-4 h-4 text-primary" /> Class Performance
            </h3>
          ...
          <div className="glass rounded-xl p-5">
            <h3 className="font-semibold mb-4 flex items-center gap-2">
              <Clock className="w-4 h-4 text-streak-orange" /> Pending Tasks
            </h3>
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          ...
          <div className="glass rounded-xl p-5">
            <h3 className="font-semibold mb-4 flex items-center gap-2">
              <AlertTriangle className="w-4 h-4 text-streak-orange" /> Weak Topic Alerts
            </h3>
            <div className="space-y-2">
              {weakTopics.map((t) => (
          ...
          <div className="glass rounded-xl p-5">
            <h3 className="font-semibold mb-4 flex items-center gap-2">
              <FileText className="w-4 h-4 text-magic-blue" /> Recent Submissions
            </h3>
            <div className="space-y-2">
